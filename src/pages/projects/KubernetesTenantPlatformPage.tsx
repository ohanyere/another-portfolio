        ...
        <div className="flex max-w-[1200px] flex-1 flex-col">
          <main className="flex-1 px-4 py-16 sm:py-20">
            <div className="mx-auto max-w-5xl space-y-8">
              ...
              {project.decisions ? (
                <section className="rounded-lg border border-gray-200 bg-white p-6">
                  <h2 className="text-2xl font-bold tracking-tight text-gray-900">Engineering Decisions</h2>
                  <div className="mt-4 space-y-3 text-sm leading-relaxed text-gray-600">
              ...
              {project.tradeOffs ? (
                <section className="rounded-lg border border-gray-200 bg-white p-6">
                  <h2 className="text-2xl font-bold tracking-tight text-gray-900">Trade-offs</h2>
                  <div className="mt-4 space-y-3 text-sm leading-relaxed text-gray-600">
              ...
              {project.limitations ? (
                <section className="rounded-lg border border-gray-200 bg-white p-6">
                  <h2 className="text-2xl font-bold tracking-tight text-gray-900">Limitations / Validation Status</h2>
                  <div className="mt-4 space-y-3 text-sm leading-relaxed text-gray-600">
